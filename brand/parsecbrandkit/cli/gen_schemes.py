...
for key, val in [
    ...
    ("Selection Color", "selectionBg"),
    ("Selected Text Color", "selectionFg"),
    ("Link Color", "cyan"),
]:
...
vs = {
    "workbench.colorCustomizations": {
        ...
        "terminal.ansiBrightBlack": "#" + P["brBlack"],
        "terminal.ansiBrightRed": "#" + P["brRed"],
        "terminal.ansiBrightGreen": "#" + P["brGreen"],
        "terminal.ansiBrightYellow": "#" + P["brYellow"],
        "terminal.ansiBrightBlue": "#" + P["brBlue"],
        "terminal.ansiBrightMagenta": "#" + P["brMagenta"],
        "terminal.ansiBrightCyan": "#" + P["brCyan"],
        "terminal.ansiBrightWhite": "#" + P["brWhite"],
    }
}
...
print(
    "generated:",
    "terminal-palette.json parsec.itermcolors windows-terminal.json vscode-terminal.json",
)
