#!/usr/bin/env python3
"""Minimal Anthropic-shaped mock upstream for local proxy testing
(CONTRIBUTING.md "Dev loop"). Stdlib only. Records every /v1/messages body to
--spool so a test can assert on what the proxy actually forwarded."""
